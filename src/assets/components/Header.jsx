        ...
        <header className="container">
          ...
          <section id="banner">
            <div className="bg-pri-500 w-full p-5 flex items-center justify-between">
              <div className="text">
                <h1 className="text-white font-bold text-5xl pb-5">Healthy and Fresh
                Grocery
                </h1>
...
function Button({Name}){
  return(
    <>
    <button className="border-1 py-2 px-5 my-5 bg-white text-pri-500 font-medium rounded-sm">{Name}</button>
    </>
  )
}
