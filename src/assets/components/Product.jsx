      ...
      <div className="container mx-auto px-4 py-5 ">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="lg:w-2/3">
            <div className="lg:flex-row flex-col p-8 text-white  rounded-2xl shadow-lg hover:shadow-2xl duration-300 bg-[#FD5151]/80 flex items-center justify-between ">
              <img
              ...
              <div className="text-center font-bold ">
                ...
                <button className="cursor-pointer border text-base  border-white rounded-lg px-5 py-2 text-white m-5 hover:bg-white hover:text-[#FD5151]/80 duration-300 transform">
                  Shop Now
                </button>
              </div>
            </div>
